    ...
    <div class="container">
      <div class="about-wrapper">
        ...
        <div class="about-infos">
          ...
          <div class="organic-food-wrapper">
            <div class="organic-food">
              <i class="organic-icon">
                <svg
                  width="46"
                  height="46"
                  viewBox="0 0 46 46"
                ...
                >
                  ...
                  <defs>
                    <pattern
                      ...
                      height="1"
                    >
                      <use xlink:href="#image0_1_85" transform="scale(0.01)" />
                    </pattern>
                    <image
                      id="image0_1_85"
                      width="100"
          ...
          <button class="about-btn">
            ...
            <i class="icon-wrapper">
              ...
              >
                <path
                  d="M15.0384 6.50003H1M9.07688 1L16 6.50003L9.07688 12V1Z"
                  stroke="white"
